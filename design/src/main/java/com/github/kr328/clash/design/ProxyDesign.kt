...
class ProxyDesign(
    ...
    init {
        ...
        if (groupNames.isEmpty()) {
            ...
            binding.emptyActionBtn.setOnClickListener { requests.trySend(ProxyDesign.Request.OpenProfiles) }
    ...
    fun requestUrlTesting() {
        urlTesting = true
        ProxyViewState.globalTesting = true  // P2-12: trigger pulse animation
    ...
    private fun updateUrlTestButtonStatus() {
        // P2-12: sync global testing pulse flag
        ProxyViewState.globalTesting = urlTesting
