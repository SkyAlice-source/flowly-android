...
class ProfilesDesign(context: Context) : Design<ProfilesDesign.Request>(context), ProfileActions {
    sealed class Request {
        ...
        object CreateFile : Request()
        object CreateUrl : Request()
        object CreateQR : Request()
        object OpenDashboard : Request()
    ...
    fun requestCreateFile() {
        requests.trySend(Request.CreateFile)
    }

    fun requestCreateUrl() {
        requests.trySend(Request.CreateUrl)
    }

    fun requestCreateQR() {
        requests.trySend(Request.CreateQR)
    }

    fun requestOpenDashboard() {
        requests.trySend(Request.OpenDashboard)
    }
