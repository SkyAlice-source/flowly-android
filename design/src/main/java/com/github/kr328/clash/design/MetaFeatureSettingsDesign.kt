    ...
    init {
        ...
        val screen = preferenceScreen(context) {
            ...
            selectableList(
                ...
                icon = R.drawable.ic_pref_network,
            )
            ...
            selectableList(
                ...
                icon = R.drawable.ic_pref_process,
            ) {
            ...
            val sniffer = selectableList(
                ...
                icon = R.drawable.ic_pref_sniffer,
            ) {
            ...
            selectableList(
                ...
                icon = R.drawable.ic_pref_target,
                configure = snifferDependencies::add,
            )
            ...
            selectableList(
                ...
                icon = R.drawable.ic_pref_database,
                configure = snifferDependencies::add,
            )
            ...
            editableTextList(
                ...
                placeholder = R.string.dont_modify,
                icon = R.drawable.ic_pref_arrow_left,
                configure = snifferDependencies::add,
            )
            ...
            editableTextList(
                ...
                placeholder = R.string.dont_modify,
                icon = R.drawable.ic_pref_arrow_right,
                configure = snifferDependencies::add,
            )
